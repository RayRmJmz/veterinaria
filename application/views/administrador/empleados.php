        ...
        <div class="modal-body" style="text-transform:uppercase;">
          <div class="form row">
            <div class="col form-group">
              ...
              <input class="form-control" type="text" name="usuario" value="" id="usuario"  readonly="">
            </div>
          </div>
          <div class="form row">
            <div class="col form-group">
          ...
          <div class="form row">
            <div class="col form-group">
              ...
              <input class="form-control" type="tel" name="celular" value="" id="celular" pattern="[0-9]{10}" placeholder="3123206062" required="" >
            </div>
          </div>
  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content">
      <div class="modal-header alert" style="background: #fe5461;">
        <h5 class="modal-title" style="color: #fff;" id="exampleModalLabel">DAR DE BAJA EMPLEADO</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="text-transform:uppercase;">
        ...
        <form>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCELAR</button>
                <button type="button" class="btn btn-danger" onclick="removeEmpleado()" data-dismiss="modal">DAR DE BAJA </button>
              </div>
      </form>
