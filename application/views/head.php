    ...
    <div class="wrapper"> 
        ...
        <aside class="left-sidebar bg-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            <!-- Aplication Brand -->
            <div class="app-brand">
              <a href="<?=base_url()?>welcome/inicio">
                <svg
                  class="brand-icon"
                  ...
                  <li  class="has-sub" >
                    ...
                    <ul  class="collapse"  id="usuarios"
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="<?=base_url()?>welcome/empleados">
                                <span class="nav-text" style="text-transform:uppercase;">Empleados</span>   
                              </a>
                            </li>

                            <li >
                              <a class="sidenav-item-link" href="<?=base_url()?>welcome/servicios">
                                <span class="nav-text" style="text-transform:uppercase;">Servicios</span>
                              </a>
                            </li>

                            <li >
                              <a class="sidenav-item-link" href="<?=base_url()?>welcome/articulos">
