...
<div class="content-wrapper">
	<div class="content">
		<div class="card">
          ...
          <div class="row">
            <div class="col-sm-10">
             <section><input type="text" name="busqueda" id="busqueda" placeholder="Buscar cliente por nombre, apellido..." class="form-control mb-6"></section>
            </div>
            <div class="col-sm-2">
              <a href="<?=base_url()?>welcome/agregarCliente" class="btn btn-primary">Agregar cliente</a>
            </div>
